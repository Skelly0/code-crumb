...
const themes = {
  ...
  responding: {
    border: [80,170,170], eye: [140,210,210], mouth: [100,180,180],
    accent: [100,190,190], label: [90,180,180], status: 'responding', emoji: '\u25cf',
  },
  starting: {
    border: [110,130,200], eye: [170,190,240], mouth: [130,150,210],
    accent: [140,160,230], label: [120,140,220], status: 'starting up', emoji: '\u00b7',
  },
  spawning: {
    border: [130,150,220], eye: [190,210,255], mouth: [150,170,230],
    accent: [160,180,250], label: [140,160,240], status: 'spawning', emoji: '\u00b7',
  },
  committing: {
    border: [200,160,40], eye: [240,200,80], mouth: [210,170,50],
    accent: [255,190,60], label: [230,175,55], status: 'committing', emoji: '\u2191',
  },
  reviewing: {
    border: [110,170,200], eye: [170,215,235], mouth: [130,195,220],
    accent: [90,155,185], label: [100,165,205], status: 'reviewing', emoji: '\u25c8',
  },
  ratelimited: {
    border: [220,160,40], eye: [250,200,80], mouth: [200,150,60],
    accent: [240,180,50], label: [230,170,45], status: 'rate limited', emoji: '\u231b',
  },
};
...
const TIMELINE_COLORS = {
  ...
  subagent:    [120, 80, 180],
  responding:  [60, 140, 140],
  starting:    [90, 110, 180],
  spawning:    [100, 120, 190],
  committing:  [170, 130, 25],
  reviewing:   [90, 150, 180],
  ratelimited: [190, 135, 25],
};
...
const STATE_THOUGHTS = {
  ...
  ratelimited: [
    'hit the wall', 'throttled...', 'waiting it out',
    'too fast I guess', 'cooldown mode', 'patience...',
  ],
};
...
const PALETTES = [
  ...
  // 1: Neon (high saturation cyans/magentas/limes)
  {
    ...
    themes: _buildPaletteThemes({
      ...
      responding:  [[50,200,200],[100,230,230],[70,210,210],[80,220,220],[60,200,200]],
      starting:    [[0,150,255],[80,190,255],[40,170,255],[60,180,255],[20,160,255]],
      spawning:    [[20,170,255],[100,210,255],[60,190,255],[80,200,255],[40,180,255]],
      ...
      ratelimited: [[255,180,0],[255,220,60],[250,190,30],[255,200,40],[255,190,20]],
    }),
    timelineColors: {
  ...
  // 2: Pastel (soft pinks/lavenders/mints)
  {
    ...
    themes: _buildPaletteThemes({
      ...
      responding:  [[140,190,190],[175,210,210],[155,195,195],[160,200,200],[150,192,192]],
      starting:    [[160,175,220],[190,205,235],[170,185,225],[175,190,225],[165,180,220]],
      spawning:    [[175,190,235],[205,220,248],[185,200,238],[190,205,238],[180,195,232]],
      ...
      ratelimited: [[225,205,150],[238,222,178],[230,212,162],[232,215,162],[228,210,158]],
    }),
    timelineColors: {
  ...
  // 3: Monochrome (greyscale, R=G=B)
  {
    ...
    themes: _buildPaletteThemes({
      ...
      responding:  [[130,130,130],[170,170,170],[145,145,145],[150,150,150],[135,135,135]],
      starting:    [[145,145,145],[185,185,185],[160,160,160],[160,160,160],[150,150,150]],
      spawning:    [[155,155,155],[195,195,195],[170,170,170],[175,175,175],[162,162,162]],
      ...
      ratelimited: [[190,190,190],[230,230,230],[205,205,205],[210,210,210],[200,200,200]],
    }),
    timelineColors: {
  ...
  // 4: Sunset/ (warm oranges/reds/golds/purples)
  {
    ...
    themes: _buildPaletteThemes({
      ...
      responding:  [[70,150,140],[120,185,175],[90,160,155],[100,170,165],[80,155,150]],
      starting:    [[130,90,170],[170,135,200],[145,105,180],[150,110,185],[135,95,175]],
      spawning:    [[150,110,190],[190,155,220],[165,125,200],[170,130,205],[155,115,195]],
      ...
      ratelimited: [[245,170,30],[255,210,80],[248,185,50],[250,190,45],[245,180,35]],
    }),
    timelineColors: {
      ...
      ratelimited: [205,140,15],
    },
  },

  // 5: High Contrast (accessibility, maximum contrast bright primaries)
  {
    name: 'highcontrast',
    themes: _buildPaletteThemes({
      idle:        [[255,255,255],[0,255,255],[255,255,255],[200,200,200],[230,230,230]],
      thinking:    [[0,255,255],[255,255,255],[0,200,255],[0,230,255],[0,240,255]],
      coding:      [[255,255,0],[255,255,255],[255,200,0],[255,230,0],[255,240,0]],
      reading:     [[0,255,0],[255,255,255],[0,200,0],[0,230,0],[0,240,0]],
      searching:   [[255,0,255],[255,255,255],[200,0,255],[230,0,255],[240,0,255]],
      executing:   [[255,165,0],[255,255,255],[255,140,0],[255,180,0],[255,170,0]],
      happy:       [[0,255,0],[255,255,0],[0,255,100],[50,255,50],[0,255,50]],
      satisfied:   [[100,255,100],[200,255,200],[150,255,150],[130,255,130],[120,255,120]],
      proud:       [[255,215,0],[255,255,100],[255,220,50],[255,225,30],[255,218,20]],
      relieved:    [[150,255,150],[200,255,200],[170,255,170],[160,255,160],[155,255,155]],
      error:       [[255,0,0],[255,255,0],[255,50,50],[255,30,30],[255,20,20]],
      sleeping:    [[100,100,255],[150,150,255],[120,120,255],[180,180,255],[160,160,255]],
      waiting:     [[180,180,255],[220,220,255],[200,200,255],[190,190,255],[185,185,255]],
      testing:     [[255,100,255],[255,200,255],[255,150,255],[255,130,255],[255,120,255]],
      installing:  [[0,200,255],[100,220,255],[50,210,255],[30,205,255],[20,202,255]],
      caffeinated: [[255,255,0],[255,0,255],[255,255,100],[255,255,50],[255,255,30]],
      subagent:    [[200,100,255],[255,200,255],[220,150,255],[210,130,255],[205,120,255]],
      responding:  [[0,200,200],[0,255,255],[0,220,220],[0,210,210],[0,205,205]],
      starting:    [[200,200,255],[230,230,255],[210,210,255],[215,215,255],[205,205,255]],
      spawning:    [[220,220,255],[255,255,255],[230,230,255],[235,235,255],[225,225,255]],
      ...
      ratelimited: [[255,200,0],[255,255,0],[255,210,50],[255,220,30],[255,215,20]],
    }),
    timelineColors: {
      idle:        [200,200,200], thinking:  [0,220,220],
      coding:      [220,220,0],   reading:   [0,200,0],
      searching:   [220,0,220],   executing: [220,140,0],
      happy:       [0,220,0],     satisfied: [80,220,80],
      proud:       [220,185,0],   relieved:  [120,220,120],
      error:       [220,0,0],     sleeping:  [80,80,220],
      waiting:     [150,150,220], testing:   [220,80,220],
      installing:  [0,170,220],   caffeinated:[220,220,0],
      subagent:    [170,80,220],
      responding:  [0,170,170],   starting:  [170,170,220],
      spawning:    [190,190,235],
      committing:  [0,220,80],    reviewing: [0,185,220],
      ratelimited: [220,170,0],
    },
  },
];
