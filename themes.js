...
const PALETTES = [
  ...
  // 1: Neon (high saturation cyans/magentas/limes)
  {
    ...
    themes: _buildPaletteThemes({
      ...
      sleeping:    [[30,20,180],[60,50,210],[40,30,190],[80,60,230],[50,40,200]],
    ...
    timelineColors: {
      ...
      error:       [200,0,45],    sleeping:  [20,15,140],
  ...
  // 2: Pastel (soft pinks/lavenders/mints)
  {
    ...
    themes: _buildPaletteThemes({
      ...
      sleeping:    [[140,135,180],[165,160,200],[150,145,190],[155,150,195],[148,143,188]],
    ...
    timelineColors: {
      ...
      error:       [185,120,130], sleeping:  [110,105,150],
  ...
  // 3: Monochrome (greyscale, R=G=B)
  {
    ...
    themes: _buildPaletteThemes({
      ...
      sleeping:    [[60,60,60],[85,85,85],[70,70,70],[80,80,80],[65,65,65]],
    ...
    timelineColors: {
      ...
      error:       [190,190,190], sleeping:  [40,40,40],
  ...
  // 4: Sunset (warm oranges/reds/golds/purples)
  {
    ...
    themes: _buildPaletteThemes({
      ...
      sleeping:    [[80,40,100],[110,70,130],[90,50,110],[100,60,120],[85,45,105]],
    ...
    timelineColors: {
      ...
      error:       [170,25,25],   sleeping:  [60,30,75],
