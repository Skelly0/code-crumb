...
const script = [
  ...
  {
    time: 5000,
    label: 'Main writes code, sub-1 searches, sub-2 starts executing',
    actions: [
      ...
      { id: 'demo-sub-2', cwd: sessions[2].cwd, state: 'executing', detail: 'npm run build' },
    ],
  },
  {
    time: 8000,
    label: 'Sub-2 hits an error! Others keep working.',
    actions: [
      { id: 'demo-sub-2', cwd: sessions[2].cwd, state: 'error', detail: 'build failed (exit 1)' },
      { id: 'demo-other', cwd: sessions[3].cwd, state: 'reading', detail: 'reading routes.ts' },
    ],
  },
  {
    time: 11000,
    label: 'Main finishes, sub-2 recovers, other starts coding',
    actions: [
      { id: 'demo-main',  cwd: sessions[0].cwd, state: 'happy',   detail: 'all done!' },
