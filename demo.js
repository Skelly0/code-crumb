...
const states = [
  ...
  { state: 'happy',     detail: 'step complete',        duration: 3000, label: 'Happy -- streak building!', success: true },
  { state: 'happy',     detail: 'step complete',        duration: 1500, label: 'Another success!', success: true },
  { state: 'happy',     detail: 'step complete',        duration: 1500, label: 'Streak climbing...', success: true },
  { state: 'happy',     detail: 'step complete',        duration: 1500, label: 'Keep going!', success: true },
  { state: 'happy',     detail: 'step complete',        duration: 1500, label: 'Building momentum', success: true },
