...
test.js          Test runner — isolates HOME, loads 15 test files from tests/ (1965 tests); --quiet, name filters
...
| `LONG_TOOL_ESCALATE_MS` | 8000ms | face.js (detail line gains "still running … Ns") |
